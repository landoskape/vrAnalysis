...
def plot_environmentStats(
    ...
    **kwConditions,
    ...
    miceInSession, env_counter, trial_counter, total_cell_count, red_cell_count = sessionStats(
        ises=ises,
        keep_planes=keep_planes,
