...
def parse_args():
    ...
    parser.add_argument("--population_name", default=None, type=str, help="Name of population object to save (default=None, just uses name of session)")
...
if __name__ == "__main__":
    ...
    if args.networks:
        do_network_optimization(all_sessions, retest_only=args.retest_only, population_name=args.population_name, skip_completed=args.skip_completed, save=args.save)
