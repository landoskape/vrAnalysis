...
def short_model_name(model_name: ModelName) -> str:
    _short_name_mapping = {
        # Placefield models
        "external_placefield_1d": "Placefield",
        "internal_placefield_1d": "Int. Placefield",
        "external_placefield_1d_gain": "Placefield (+Gain)",
        "internal_placefield_1d_gain": "Int. Placefield (+Gain)",
        "external_placefield_1d_vector_gain": "Placefield (+Additive)",
        "internal_placefield_1d_vector_gain": "Int. Placefield (+Additive)",
        # Latent variable models
        "rbfpos_decoder_only": "HighD-Pos",
        "rbfpos": "Int. HighD-Pos",
        "rbfpos_leak": "IntLeak HighD-Pos",
        "pos_speed_decoder_only": "HighD-Pos+HighD-Speed",
        "pos_speed": "Int. HighD-Pos+HighD-Speed",
        "pos_speed_leak": "IntLeak HighD-Pos+HighD-Speed",
        "fullregressor_decoder_only": "HighD-Pos+HighD-Speed+Reward",
        "fullregressor": "Int. HighD-Pos+HighD-Speed+Reward",
        "fullregressor_leak": "Int. HighD-Pos+HighD-Speed+Reward + Leak",
        # Latent variable models with 1D speed
        "pos_speed_decoder_only_1dspeed": "HighD-Pos+Speed",
        "pos_speed_1dspeed": "Int. HighD-Pos+Speed",
        "pos_speed_leak_1dspeed": "Int. HighD-Pos+Speed + Leak",
        "fullregressor_decoder_only_1dspeed": "HD-Pos+Speed+Reward",
        "fullregressor_1dspeed": "Int. HD-Pos+Speed+Reward",
        "fullregressor_leak_1dspeed": "Int. HD-Pos+Speed+Reward + Leak",
        # Latent variable models without y-intercept
        "rbfpos_decoder_only_no_intercept": "HighD-Pos (no int)",
        "rbfpos_no_intercept": "Int. HighD-Pos (no int)",
        "rbfpos_leak_no_intercept": "Int. HighD-Pos (no int) + Leak",
        "pos_speed_decoder_only_no_intercept": "HighD-Pos+Speed (no int)",
        "pos_speed_no_intercept": "Int pos+speed (no int)",
        "pos_speed_leak_no_intercept": "Int. pos+speed (no int) + Leak",
        "fullregressor_decoder_only_no_intercept": "HighD-Pos+HighD-Speed+Reward (no int)",
        "fullregressor_no_intercept": "Int. HighD-Pos+HighD-Speed+Reward (no int)",
        "fullregressor_leak_no_intercept": "Int. HighD-Pos+HighD-Speed+Reward (no int) + Leak",
        # Reduced rank regression models
        "rrr": "RRR",
