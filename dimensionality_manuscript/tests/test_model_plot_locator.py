...
FULL_NO_INTERCEPT_ANCHOR_IDX = [6, 7, 8, 15, 16, 17, 18, 19, 20, 30, 35, 36, 37, 35, 36, 37]
FULL_VECTOR_GAIN_IDX = [4, 5, 46, 47]
FULL_VECTOR_GAIN_ANCHOR_IDX = [2, 3, 2, 3]
...
REDUCED_NO_INTERCEPT_ANCHOR_IDX = [6, 15, 18, 30, 35, 35]
REDUCED_VECTOR_GAIN_IDX = [4, 5, 46, 47]
REDUCED_VECTOR_GAIN_ANCHOR_IDX = [2, 3, 2, 3]
