...
class vrExperiment(vrSession):
    ...
    def populateFromExisting(self, vrExp):
        self.mouseName = vrExp.mouseName
        self.dateString = vrExp.dateString
        self.session = vrExp.session
        self.opts = vrExp.opts
        self.preprocessing = vrExp.preprocessing
        self.value = vrExp.value
        self.loadBuffer = vrExp.loadBuffer
...
class redCellProcessing(vrExperiment):
    ...
    def __init__(self,*inputs,umPerPixel=1.3):
        if len(inputs)==1: 
            ...
            self.populateFromExisting(inputs[0])
        elif len(inputs)==3: 
            createFromVrExp = False
