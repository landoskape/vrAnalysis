...
dataPath = Path('C:/Users/andrew/Documents/localData')
...
class vrExperiment(vrSession):
    ...
    def __init__(self,*inputs):
        ...
        # requires the vrExperimentRegistration to have already been run for this session!
    ...
    def createObject(self, *inputs):
        ...
        - vrExperimentRegistration: populate from existing allows the user to re-register things without starting from scratch
